    ...
    : width{w}, height{h}, gWindow{nullptr}, gRenderer{nullptr}
{
    ...
    if (gRenderer == nullptr) {
        ...
        // Feed the locator so we can track the renderer
        Locator<SDL_Renderer>::reset(gRenderer);
    }
    ...
    Locator<MainWindow>::reset(this);
}

MainWindow::~MainWindow() noexcept
{
    SDL_DestroyRenderer( gRenderer );
    Locator<SDL_Renderer>::reset(nullptr);
    ...
    Locator<MainWindow>::reset(nullptr);
}
